...
<head>
  ...
  <title>Mathematics Excellence Portal • Fractions Master Suite: Comprehensive Practice</title>
...
<body>
  ...
  <header>
    <div class="brand-wrap">
      ...
      <div class="brand-title">
        <h1>Mathematics Excellence Portal • Fractions Master Suite</h1>
        <p>Comprehensive Notes, Division, Mixed Numbers, Ordering &amp; Operations Practice</p>
      </div>
    </div>
  ...
  <nav>
    <button class="tab-btn active" id="tabTheoryBtn" onclick="switchMainTab('theory')">
      📖 Theory &amp; Fraction Notes Hub
    </button>
    <button class="tab-btn" id="tabPracticeBtn" onclick="switchMainTab('practice')">
      🎯 Interactive Practice Workstation (25 Problems)
    </button>
  ...
  <div id="loginGateView">
    <div class="login-box">
      <h2>Mathematics Excellence Portal</h2>
      <p>Fractions Learning Portal with Step-Gated Practice &amp; Virtual Math Keyboard</p>
  ...
  <main>
    <!-- View 1: Theory, Descriptive Notes & Hub (First Sheet) -->
    <div id="viewTheory" class="view active">
      <div class="theory-card">
        <h3>📖 Fractions Master Notes &amp; Concepts Hub</h3>
        <p class="theory-intro-text">
          A fraction represents parts of a whole or collection. Review the core definitions, naming rules, division relations, mixed numbers, and operations below.
        </p>

        <div class="compendium-grid">
          <div class="comp-card">
            <h4>1. Anatomy &amp; Naming of Fractions</h4>
            <div class="recap-body">
              <div class="formula-box">
                \[\frac{\text{Numerator}}{\text{Denominator}} = \frac{\text{Parts we are looking at}}{\text{Total equal parts in a whole}}\]
                <p>• <strong>Denominator:</strong> Number of equal parts in a whole.</p>
                <p>• <strong>Numerator:</strong> Number of parts considered.</p>
                <p>• <strong>Naming:</strong> Most denominators add "-th". Exceptions: 2 = half, 3 = third, 4 = quarter/fourth.</p>
              </div>
            </div>
          </div>

          <div class="comp-card">
            <h4>2. Fractions as Division</h4>
            <div class="recap-body">
              <div class="formula-box">
                \[a \div b = \frac{a}{b}\]
                <p>A fraction bar is another way of writing division. For example, dividing 4 items among 5 parts is written as \(\frac{4}{5}\).</p>
              </div>
            </div>
          </div>

          <div class="comp-card">
            <h4>3. Improper Fractions &amp; Mixed Numbers</h4>
            <div class="recap-body">
              <div class="formula-box">
                <p>• <strong>Improper Fraction:</strong> Numerator \(\ge\) Denominator (e.g., \(\frac{4}{3}\)).</p>
                <p>• <strong>Mixed Number:</strong> A whole number and a proper fraction combined (e.g., \(1\frac{1}{3}\)).</p>
              </div>
            </div>
          </div>

          <div class="comp-card">
            <h4>4. Adding &amp; Subtracting Fractions</h4>
            <div class="recap-body">
              <div class="formula-box">
                <p>• <strong>Like Denominators:</strong> Add or subtract the numerators while keeping the denominator the same:</p>
        ...
        <aside>
          <div class="palette-box">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
              <h4>All 25 Fraction Problems</h4>
              <span style="font-size:0.8rem; color:var(--text-muted);" id="paletteCount">0 / 25 Solved</span>
            </div>
          ...
          <div class="palette-box" style="background: #f8fafc;">
            ...
            <p style="font-size: 0.82rem; line-height: 1.6; color: var(--text-muted);">
              ...
              • <strong>Virtual Keyboard:</strong> Use fraction and math symbols easily.
            </p>
          </div>
        </aside>
      </div>
    ...
    <div id="viewScorecard" class="view">
      <div class="hero-score-card">
        <h2>Mathematics Excellence Portal Scorecard</h2>
  ...
  <script>
    /* ==========================================================================
       25 COMPREHENSIVE FRACTION PROBLEMS
       ========================================================================== */
    const rawFractions = [
      { id: 1, title: "Writing Fractions in Words", expr: "\\text{Write in words: } \\frac{2}{3}", hint: "Numerator is 2, denominator 3 is 'third'.", ans: "\\text{two thirds}", dist1: "\\text{three halves}", dist2: "\\text{two second}", dist3: "\\text{third two}" },
      { id: 2, title: "Writing Fractions in Words", expr: "\\text{Write in words: } \\frac{3}{4}", hint: "Denominator 4 is 'quarter'.", ans: "\\text{three quarters}", dist1: "\\text{three fourths}", dist2: "\\text{four thirds}", dist3: "\\text{third quarters}" },
      { id: 3, title: "Writing Fractions in Words", expr: "\\text{Write in words: } \\frac{5}{7}", hint: "Denominator 7 is 'seventh'.", ans: "\\text{five sevenths}", dist1: "\\text{seven fifths}", dist2: "\\text{five sevens}", dist3: "\\text{seventh fives}" },
      { id: 4, title: "Writing Fractions in Words", expr: "\\text{Write in words: } \\frac{9}{10}", hint: "Denominator 10 is 'tenth'.", ans: "\\text{nine tenths}", dist1: "\\text{ten ninths}", dist2: "\\text{nine tens}", dist3: "\\text{tenth nines}" },
      { id: 5, title: "Division to Fraction", expr: "\\text{Write as a fraction: } 4 \\div 5", hint: "Dividend becomes the numerator, divisor becomes the denominator.", ans: "\\frac{4}{5}", dist1: "\\frac{5}{4}", dist2: "4.5", dist3: "20" },
      { id: 6, title: "Division to Fraction", expr: "\\text{Write as a fraction: } 3 \\div 10", hint: "Dividend is numerator, divisor is denominator.", ans: "\\frac{3}{10}", dist1: "\\frac{10}{3}", dist2: "3.10", dist3: "30" },
      { id: 7, title: "Fraction to Division", expr: "\\text{Write as a division: } \\frac{2}{5}", hint: "Numerator divided by denominator.", ans: "2 \\div 5", dist1: "5 \\div 2", dist2: "2 \\times 5", dist3: "\\frac{5}{2}" },
      { id: 8, title: "Fraction to Division", expr: "\\text{Write as a division: } \\frac{7}{8}", hint: "Numerator divided by denominator.", ans: "7 \\div 8", dist1: "8 \\div 7", dist2: "7 \\times 8", dist3: "\\frac{8}{7}" },
      { id: 9, title: "Fraction to Whole Number", expr: "\\text{Write as a division, and hence as a whole number: } \\frac{20}{5}", hint: "Compute \\(20 \\div 5\\).", ans: "4", dist1: "5", dist2: "20", dist3: "4.5" },
      { id: 10, title: "Fraction to Whole Number", expr: "\\text{Write as a division, and hence as a whole number: } \\frac{27}{3}", hint: "Compute \\(27 \\div 3\\).", ans: "9", dist1: "3", dist2: "27", dist3: "8" },
      { id: 11, title: "Improper Fraction to Mixed Number", expr: "\\text{Write as a mixed number: } \\frac{9}{4}", hint: "Divide 9 by 4: \\(9 = 4 \\times 2 + 1\\).", ans: "2\\frac{1}{4}", dist1: "2\\frac{1}{2}", dist2: "4\\frac{1}{4}", dist3: "1\\frac{3}{4}" },
      { id: 12, title: "Improper Fraction to Mixed Number", expr: "\\text{Write as a mixed number: } \\frac{16}{5}", hint: "Divide 16 by 5: \\(16 = 5 \\times 3 + 1\\).", ans: "3\\frac{1}{5}", dist1: "3\\frac{3}{5}", dist2: "5\\frac{1}{3}", dist3: "2\\frac{3}{5}" },
      { id: 13, title: "Word Problem: Sharing Carrots", expr: "\\text{19 carrots are shared equally between 5 horses. Give your answer as a mixed number.}", hint: "Divide 19 by 5.", ans: "3\\frac{4}{5}", dist1: "5\\frac{3}{5}", dist2: "3\\frac{1}{5}", dist3: "4\\frac{3}{5}" },
      { id: 14, title: "Word Problem: Chillies into Fifths", expr: "\\text{Yiu Min cut 8 chillies into fifths. How many fifths did she have?}", hint: "Multiply \\(8 \\times 5\\).", ans: "40", dist1: "8", dist2: "5", dist3: "13" },
      { id: 15, title: "Ascending Order of Fractions", expr: "\\text{Rewrite each group of fractions in ascending order: } \\frac{2}{6}, \\frac{3}{12}, \\frac{5}{12}", hint: "Convert \\(\\frac{2}{6}\\) to \\(\\frac{4}{12}\\).", ans: "\\frac{3}{12}, \\frac{2}{6}, \\frac{5}{12}", dist1: "\\frac{2}{6}, \\frac{3}{12}, \\frac{5}{12}", dist2: "\\frac{5}{12}, \\frac{2}{6}, \\frac{3}{12}", dist3: "\\frac{3}{12}, \\frac{5}{12}, \\frac{2}{6}" },
      { id: 16, title: "Ascending Order of Fractions", expr: "\\text{Rewrite each group of fractions in ascending order: } \\frac{8}{12}, \\frac{11}{12}, \\frac{5}{6}", hint: "Convert \\(\\frac{5}{6}\\) to \\(\\frac{10}{12}\\).", ans: "\\frac{5}{6}, \\frac{8}{12}, \\frac{11}{12}", dist1: "\\frac{8}{12}, \\frac{11}{12}, \\frac{5}{6}", dist2: "\\frac{11}{12}, \\frac{5}{6}, \\frac{8}{12}", dist3: "\\frac{8}{12}, \\frac{5}{6}, \\frac{11}{12}" },
      { id: 17, title: "Descending Order of Fractions", expr: "\\text{Rewrite each group of fractions in descending order: } \\frac{3}{10}, \\frac{4}{5}, \\frac{7}{10}", hint: "Convert \\(\\frac{4}{5}\\) to \\(\\frac{8}{10}\\).", ans: "\\frac{4}{5}, \\frac{7}{10}, \\frac{3}{10}", dist1: "\\frac{3}{10}, \\frac{7}{10}, \\frac{4}{5}", dist2: "\\frac{7}{10}, \\frac{4}{5}, \\frac{3}{10}", dist3: "\\frac{4}{5}, \\frac{3}{10}, \\frac{7}{10}" },
      { id: 18, title: "Descending Order of Fractions", expr: "\\text{Rewrite each group of fractions in descending order: } \\frac{5}{8}, \\frac{3}{4}, \\frac{9}{16}", hint: "Convert denominators to 16.", ans: "\\frac{3}{4}, \\frac{5}{8}, \\frac{9}{16}", dist1: "\\frac{9}{16}, \\frac{5}{8}, \\frac{3}{4}", dist2: "\\frac{5}{8}, \\frac{3}{4}, \\frac{9}{16}", dist3: "\\frac{3}{4}, \\frac{9}{16}, \\frac{5}{8}" },
      { id: 19, title: "Adding Like Fractions", expr: "\\text{Find: } \\frac{1}{7} + \\frac{2}{7}", hint: "Add numerators over common denominator 7.", ans: "\\frac{3}{7}", dist1: "\\frac{3}{14}", dist2: "\\frac{2}{7}", dist3: "\\frac{1}{7}" },
      { id: 20, title: "Subtracting Like Fractions", expr: "\\text{Find: } \\frac{5}{4} - \\frac{2}{4}", hint: "Subtract numerators over common denominator 4.", ans: "\\frac{3}{4}", dist1: "\\frac{3}{8}", dist2: "\\frac{7}{4}", dist3: "\\frac{1}{4}" },
      { id: 21, title: "Adding Three Like Fractions", expr: "\\text{Find: } \\frac{10}{13} + \\frac{8}{13} + \\frac{11}{13}", hint: "Add \\(10 + 8 + 11\\).", ans: "\\frac{29}{13}", dist1: "\\frac{29}{39}", dist2: "\\frac{21}{13}", dist3: "2\\frac{3}{13}" },
      { id: 22, title: "Operations in Lowest Terms", expr: "\\text{Find, giving your answer in lowest terms: } \\frac{3}{4} - \\frac{1}{4}", hint: "\\(\\frac{2}{4}\\) simplified.", ans: "\\frac{1}{2}", dist1: "\\frac{2}{4}", dist2: "\\frac{1}{4}", dist3: "\\frac{3}{8}" },
      { id: 23, title: "Operations in Lowest Terms", expr: "\\text{Find, giving your answer in lowest terms: } \\frac{2}{9} + \\frac{1}{9}", hint: "\\(\\frac{3}{9}\\) simplified.", ans: "\\frac{1}{3}", dist1: "\\frac{3}{9}", dist2: "\\frac{3}{18}", dist3: "\\frac{1}{9}" },
      { id: 24, title: "Addition & Subtraction Combined", expr: "\\text{Find, giving your answer in lowest terms: } \\frac{8}{4} - \\frac{3}{4} - \\frac{3}{4}", hint: "\\(8 - 3 - 3 = 2\\), so \\(\\frac{2}{4}\\).", ans: "\\frac{1}{2}", dist1: "\\frac{2}{4}", dist2: "\\frac{2}{12}", dist3: "0" },
      { id: 25, title: "Mixed Operations on Fractions", expr: "\\text{Find, giving your answer in lowest terms: } \\frac{3}{10} + \\frac{7}{10} - \\frac{2}{10}", hint: "\\(3 + 7 - 2 = 8\\), simplify \\(\\frac{8}{10}\\).", ans: "\\frac{4}{5}", dist1: "\\frac{8}{10}", dist2: "\\frac{5}{5}", dist3: "\\frac{4}{10}" }
    ];
    ...
    rawFractions.forEach(item => {
      ...
      PROBLEMS_DATA.push({
        ...
        steps: [
          {
            title: "Step 1: Concept Setup & Simplification",
            prompt: "Select the correct setup or intermediate form for this fraction problem.",
            options: finalOpts,
            correctIndex: correctPos,
            explanation: `Applying fraction rules yields the correct solution: \\(${item.ans}\\).`
          }
        ]
      });
    });
    ...
    /* ==========================================================================
       ...
       ========================================================================== */
    const STORAGE_KEY = "mathematics_portal_fractions_25_v2";
    ...
    function resetStudentProgress() {
      if (confirm("Reset all 25 problem attempts and scorecard progress?")) {
    ...
    function loadProblem(pId) {
        ...
        stepsHtml += `
          <div class="step-unit ${sp.resolved ? 'completed' : ''}">
            ...
            <div class="virtual-keyboard">
              ...
              <button class="vk-btn" onclick="insertSymbol('/')">/</button>
              <button class="vk-btn" onclick="insertSymbol('÷')">÷</button>
              <button class="vk-btn" onclick="insertSymbol('1')">1</button>
              <button class="vk-btn" onclick="insertSymbol('2')">2</button>
            </div>
      ...
      card.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap;">
          <span class="concept-tag">Mathematics Excellence Portal</span>
          <span style="font-size:0.82rem; color:var(--text-muted);">Fractions Mastery Practice</span>
        </div>
